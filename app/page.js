  ...
  return (
    <div className="flex   ">
      <div className="w-1/2"><Image
        src='/rohan.jpg' alt="" width={1000} height={1000} className="object-contain rounded-s-full"
      /></div>

      <div className="">
        {/* TITLE  */}
        <h1 className="text-4xl font-bold md-6xl">Crafting  Digital Expreiences, Desining Tomorrow</h1>
        {/* DESC  */}
